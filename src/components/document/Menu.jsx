...
function Menu({setDocumentName, userType}) {
    ...
    <div>
        ...
        {
            openRenameWindow && 
            <div className='absolute left-[15%] top-[8%]  bg-gray-400/50 left-50 flex z-10 '>
                <div>
                    <input  
                        type="text" 
        ...
        {
            openDeleteWindow && 
                <div className='absolute left-[15.2%] top-[14.2%]  bg-gray-400/50 left-50 flex z-10 justify-around w-[7%] p-2 '>
                        <div >
