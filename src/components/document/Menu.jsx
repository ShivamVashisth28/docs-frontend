...
function Menu({setDocumentName, userType}) {
    ...
    <div className=''>
        ...
        {
            openDownloadWindow && 
            <div className={`bg-gray-300 absolute flex items-center justify-evenly ${userType === 'owner' && 'top-[12.5rem]'} ${userType === 'viewer' && 'top-[4.2rem]'} ${userType === 'editor' && 'top-[6.5rem]'}  left-[14.6rem] h-[4rem] rounded-md w-[10%] z-10`}>
